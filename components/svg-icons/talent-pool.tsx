...
const TalentPool: React.FC<SVGProps> = ({ height, width }) => {
  return (
    <div className="svg-icon-dark">
      ...
      >
        <path
          d="M41,53.1c9.1,0,16.6,7.4,16.6,16.6S50.2,86.2,41,86.2s-16.6-7.4-16.6-16.6S31.9,53.1,41,53.1z M84.7,53.1
