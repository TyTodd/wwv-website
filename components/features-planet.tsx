      ...
      <div className="mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="flex flex-row">
            <SimpleCard title="Startups Lack Female Talent" delay={0}>
              According to Forbes, women make up less than 15% of the workforce
              in more than one in five startups.
            </SimpleCard>
            <SimpleCard title="Female Founders Reach Record Low" delay={150}>
              Carta reports that over the past several years, men have
              outnumbered women in new startup founder roles by nearly six to
              one. In 2023, this gender disparity worsened, with just 13.2% of
              founders being women, down from 15.1% in 2022. This is the lowest
              percentage recorded by Carta since at least 2018.
            </SimpleCard>
            <SimpleCard title="Females Not Funded" delay={300}>
              According to the World Economic Forum, female founders received
              only 2% of total venture capital in 2023, with Black female
              founders receiving near zero percent.
            </SimpleCard>
          </div>
          {/* <div className="">
